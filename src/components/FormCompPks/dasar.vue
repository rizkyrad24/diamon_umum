        ...
        <h1 class="text-xl font-medium pl-4 py-6">Dasar</h1>
                ...
                <div>
                    ...
                    <div class="relative w-[540px] mt-2 jenis-container">
                        <button @click="jenisDropdown" :class="{'rounded-t-lg': isJenisOpen, 'rounded-lg text-[#7F7F80]': !isJenisOpen}" class="w-[540px] py-[10px] px-4 border-[1px] text-sm flex justify-between items-center">
                            <span :class="{'text-black': jenissOption, 'text-[#9C9C9C]': !jenissOption}">{{ jenissOption?.label || 'Pilih Jenis Kemitraan' }}</span>
                        ...
                        <div v-show="isJenisOpen" class="w-[540px] border-[1px] rounded-b-lg z-10">
                            <ul class="text-sm">
                                <li @click="jenisOption({value: 'JO', label: 'Join Operation'})" :class="{'bg-[#2671D9] text-white': jenissOption?.value === 'JO', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': jenissOption?.value !== 'JO'}" class="cursor-pointer border-b-[1px] px-4 py-2">Join Operation</li>
                                <li @click="jenisOption({value: 'R', label: 'Resseler'})" :class="{'bg-[#2671D9] text-white': jenissOption?.value === 'R', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': jenissOption?.value !== 'R'}" class="cursor-pointer border-b-[1px] px-4 py-2">Resseler</li>
                                <li @click="jenisOption({value: 'B', label: 'Bundling Layanan'})" :class="{'bg-[#2671D9] text-white': jenissOption?.value === 'B', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': jenissOption?.value !== 'B'}" class="cursor-pointer border-b-[1px] px-4 py-2">Bundling Layanan</li>
                                <li @click="jenisOption({value: 'JI', label: 'Join Investmen'})" :class="{'bg-[#2671D9] text-white rounded-b-lg': jenissOption?.value === 'JI', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': jenissOption?.value !== 'JI'}" class="cursor-pointer px-4 py-2">Join Investmen</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="pl-4 mt-7 w-[1155px] flex justify-between">
                ...
                <div>
                    ...
                    <div class="relative w-[540px] mt-2 tipe-container">
                        ...
                        <div v-show="isTipeOpen" class="w-[540px] border-[1px] rounded-b-lg z-10">
                            <ul class="text-sm">
                                <li @click="tipeOption({value: 'C', label: 'Capex'})" :class="{'bg-[#2671D9] text-white': tipeeOption?.value === 'C', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': tipeeOption?.value !== 'C'}" class="cursor-pointer border-b-[1px] px-4 py-2">Capex</li>
                                <li @click="tipeOption({value: 'O', label: 'Opex'})" :class="{'bg-[#2671D9] text-white': tipeeOption?.value === 'O', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': tipeeOption?.value !== 'O'}" class="cursor-pointer border-b-[1px] px-4 py-2">Opex</li>
                                <li @click="tipeOption({value: 'OC', label: 'Capex & Apex'})" :class="{'bg-[#2671D9] text-white rounded-b-lg': tipeeOption?.value === 'OC', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': tipeeOption?.value !== 'OC'}" class="cursor-pointer border-b-[1px] px-4 py-2">Capex & Apex</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="translate-x-4">
                    ...
                    <form action="" class="w-[555px] py-[10px] px-4 mt-2 border-[1px] rounded-lg text-sm flex justify-between">
                        <input @input="changenoBudget($event.target.value)" :value="noBudgetInput" type="text" placeholder="Masukkan Nomor Anggaran" class="w-[450px] outline-none">
                    </form>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="relative w-[540px] mt-2 metode-container">
                        <button @click="metodeDropdown" :class="{'rounded-t-lg': isMetodeOpen, 'rounded-lg text-[#7F7F80]': !isMetodeOpen}" class="w-[540px] py-[10px] px-4 border-[1px] text-sm flex justify-between items-center">
                            <span :class="{'text-black': metodeeOption, 'text-[#9C9C9C]': !metodeeOption}">{{ metodeeOption?.label || 'Pilih Metode Kemitraan' }}</span>
                                <svg width="16" height="16" class="ml-3" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.70711 11.2071C8.31658 11.5976 7.68342 11.5976 7.29289 11.2071L2.29289 6.20711C1.90237 5.81658 1.90237 5.18342 2.29289 4.79289C2.68342 4.40237 3.31658 4.40237 3.70711 4.79289L8 9.08579L12.2929 4.79289C12.6834 4.40237 13.3166 4.40237 13.7071 4.79289C14.0976 5.18342 14.0976 5.81658 13.7071 6.20711L8.70711 11.2071Z" fill="#2671D9"/>
                                </svg>
                        </button>
                        <div v-show="isMetodeOpen" class="w-[540px] border-[1px] rounded-b-lg z-10">
                            <ul class="text-sm">
                                <li @click="metodeOption({value: 'T1', label: 'Tunjuk Langsung'})" :class="{'bg-[#2671D9] text-white': metodeeOption?.value === 'T1', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': metodeeOption?.value !== 'T1'}" class="cursor-pointer border-b-[1px] px-4 py-2">Tunjuk Langsung</li>
                                <li @click="metodeOption({value: 'T2', label: 'Terbuka'})" :class="{'bg-[#2671D9] text-white rounded-b-lg': metodeeOption?.value === 'T2', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': metodeeOption?.value !== 'T2'}" class="cursor-pointer border-b-[1px] px-4 py-2">Terbuka</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative w-[540px] mt-2 material-container">
                        <button @click="materialDropdown" :class="{'rounded-t-lg': isMaterialOpen, 'rounded-lg text-[#7F7F80]': !isMaterialOpen}" class="w-[555px] py-[10px] px-4 border-[1px] text-sm flex justify-between items-center">
                            <span :class="{'text-black': materiallOption, 'text-[#9C9C9C]': !materiallOption}">{{ materiallOption?.label || 'Pilih Jenis Material' }}</span>
                                <svg width="16" height="16" class="ml-3" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.70711 11.2071C8.31658 11.5976 7.68342 11.5976 7.29289 11.2071L2.29289 6.20711C1.90237 5.81658 1.90237 5.18342 2.29289 4.79289C2.68342 4.40237 3.31658 4.40237 3.70711 4.79289L8 9.08579L12.2929 4.79289C12.6834 4.40237 13.3166 4.40237 13.7071 4.79289C14.0976 5.18342 14.0976 5.81658 13.7071 6.20711L8.70711 11.2071Z" fill="#2671D9"/>
                                </svg>
                        </button>
                        <div v-show="isMaterialOpen" class="w-[555px] border-[1px] rounded-b-lg z-10">
                            <ul class="text-sm">
                                <li @click="materialOption({value: 'M', label: 'Material Only'})" :class="{'bg-[#2671D9] text-white': materiallOption?.value === 'M', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': materiallOption?.value !== 'M'}" class="cursor-pointer border-b-[1px] px-4 py-2">Material Only</li>
                                <li @click="materialOption({value: 'S', label: 'Service Only'})" :class="{'bg-[#2671D9] text-white': materiallOption?.value === 'S', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': materiallOption?.value !== 'S'}" class="cursor-pointer border-b-[1px] px-4 py-2">Service Only</li>
                                <li @click="materialOption({value: 'MS', label: 'Material and Service'})" :class="{'bg-[#2671D9] text-white rounded-b-lg': materiallOption?.value === 'MS', 'hover:bg-[#E9F1FB] hover:text-[#2671D9] hover:font-medium': materiallOption?.value !== 'MS'}" class="cursor-pointer border-b-[1px] px-4 py-2">Material and Service</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="ml-4 mt-6">
                ...
                <form action="" class="w-[1150px] h-[88px] px-4 py-1 mt-2 border-[1px] rounded-lg text-sm">
                    <input @input="changeTitle($event.target.value)" :value="titleInput" type="text" placeholder="Masukkan Judul" class="w-[1080px] outline-none">
                </form>
            </div>
    </div>
</template>
