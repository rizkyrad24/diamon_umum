                ...
                <div class="bg-white rounded-lg shadow-lg w-[973px] h-[690px]">
                    ...
                    <div class="pl-4 mt-7 w-[1125px] flex justify-between">
                        <div>
                            ...
                            <div class="relative w-[529px] mt-2">
                                <form class="w-[454px] h-[40px] px-4 border-[1px] rounded-lg text-sm flex justify-between items-center">
                                    <input v-model="pelangganInput" type="text" class="w-[399px] outline-none" placeholder="Cari pelanggan" name="" id="pelanggan">
                        ...
                        <div class="-translate-x-44">
                            ...
                            <form class="w-[454px] h-[40px] px-4 mt-2 border-[1px] rounded-lg text-sm flex justify-between items-center">
                                <input v-model="produkInput" type="text" class="w-[399px] outline-none" placeholder="Cari produk" name="" id="pelanggan">
                                <svg width="17" height="16" class="cursor-pointer ml-2" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.49992 2.66683C5.10668 2.66683 3.16659 4.60693 3.16659 7.00016C3.16659 9.3934 5.10668 11.3335 7.49992 11.3335C8.69672 11.3335 9.77914 10.8492 10.564 10.0643C11.349 9.27938 11.8333 8.19696 11.8333 7.00016C11.8333 4.60693 9.89315 2.66683 7.49992 2.66683ZM1.83325 7.00016C1.83325 3.87055 4.3703 1.3335 7.49992 1.3335C10.6295 1.3335 13.1666 3.87055 13.1666 7.00016C13.1666 8.32447 12.7117 9.54343 11.9506 10.508L14.9713 13.5288C15.2317 13.7891 15.2317 14.2112 14.9713 14.4716C14.711 14.7319 14.2889 14.7319 14.0285 14.4716L11.0078 11.4508C10.0432 12.2119 8.82422 12.6668 7.49992 12.6668C4.3703 12.6668 1.83325 10.1298 1.83325 7.00016Z" fill="#2671D9"/>
                                </svg>
                            </form>
                    ...
                    <div class="pl-4 mt-6 w-[1125px] flex justify-between">
                        ...
                        <div class="-translate-x-44">
                            ...
                            <form class="w-[454px] h-[40px] px-4 mt-2 border-[1px] rounded-lg text-sm flex justify-between items-center">
                                <span class="mr-2">Rp.</span><input v-model="revenueInput" type="text" class="w-[399px] outline-none" placeholder="Masukan Revenue" id="pelanggan">
                            </form>
                        </div>
                    </div>
                    <div class="pl-4 mt-6">
                        ...
                        <form class="w-[454px] h-[40px] px-4 mt-2 border-[1px] rounded-lg text-sm flex justify-between items-center">
                            <span class="mr-2">Rp.</span><input v-model="biayaInput" type="text" class="w-[399px] outline-none" placeholder="Masukan Biaya" id="pelanggan">
                        </form>
                    </div>
                    <div class="pl-4 mt-6">
                        <label class="text-[#4D5E80] font-medium">Biaya <span class="text-[#FF5656]">*</span></label> 
                        <form class="w-[925px] h-[90px] px-4 mt-2 border-[1px] rounded-lg text-sm p-1">
                            <input v-model="deskInput" type="text" class="w-[900px] outline-none" placeholder="Masukkan Deskripsi" id="pelanggan">
                        </form>
                    </div>
                    ...
                    <div class="flex justify-end w-[925px] mt-4 gap-1">
                        ...
                        <button :disabled="isSimpanDisable" v-if="statusForm == 'add'" @click="openOk" :class="isSimpanDisable? 'w-[80px] h-[40px] bg-[#9C9C9C] text-white rounded-lg':'w-[80px] h-[40px] bg-[#2671D9] text-white rounded-lg'">Tambah</button>
                        <button :disabled="isSimpanDisable" v-if="statusForm == 'edit'" @click="openEditOk" :class="isSimpanDisable? 'w-[80px] h-[40px] bg-[#9C9C9C] text-white rounded-lg':'w-[80px] h-[40px] bg-[#2671D9] text-white rounded-lg'">Edit</button>
                        <button v-if="statusForm == 'edit'" @click="deleteDataById" class="w-[80px] h-[40px] bg-[red] text-white rounded-lg">Hapus</button>
                    </div> 
                </div>
            </div>
        </div>
...
const getNewId = () => {
  if (dataRows.value.length === 0) return 1;
  return dataRows.value[dataRows.value.length - 1].id + 1;
};
...
watch(
  ...
  ([newpelangganInput, newprodukInput, newrevenueInput, newbiayaInput, newdeskInput, newPlnOption]) => {
    isSimpanDisable.value =
      !(newpelangganInput.trim() !== '' &&
      newbiayaInput.trim() !== '' &&
      newdeskInput.trim() !== '' &&
      newPlnOption.trim() !== '' &&
      newprodukInput.trim() !== '' &&
      newrevenueInput.trim() !== '');
  },
