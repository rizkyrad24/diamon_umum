...
const emit = defineEmits(['isPos3Filled'])
    ...
    newTemplate.innerHTML = `
        <div class="py-2 flex ml-1">
            ...
            <div class="w-[1070px] h-[48px] border-[1px] rounded-e-lg py-2 px-3">
                <input class="mt-1 w-full outline-none input-pos-3" type="text" placeholder="Lingkup Pekerjaan ${templateCount + 0}">    
            </div> 
