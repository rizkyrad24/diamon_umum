...
async function postMounda(successFunction, failFunction) {
  ...
  scopes.value.forEach((element) => {
    if (element.id) {
      form.append(`scopesMou[${index}].id`, element.id)
    }
    form.append(`scopesMou[${index}].scopeName`, element.scopeName)
    index++
  });
  ...
  if (fileSurat.value || fileSuratId.value) {
    ...
    if (fileSuratId.value) {
      form.append(`attachmentsMou[${sort}].id`, fileSuratId.value)
    }
    sort++
  }
  if (fileProposal.value || fileProposalId.value) {
    ...
    if (fileProposalId.value) {
      form.append(`attachmentsMou[${sort}].id`, fileProposalId.value)
    }
    sort++
  }
  if (fileLainnya.value || fileLainnyaId.value) {
    ...
    if (fileLainnyaId.value) {
      form.append(`attachmentsMou[${sort}].id`, fileLainnyaId.value)
    }
    sort++
  }
  // Display the values
