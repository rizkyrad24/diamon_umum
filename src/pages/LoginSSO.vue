...
<template>
  ...
  <div class="bg-slate-100 flex items-center justify-center">
    ...
    <div class="flex justify-center items-center min-h-screen bg-[#F2E2B1] w-[1366px] shadow-lg px-[50px]">
      <div class="w-[643px] h-full flex justify-center self-start ml-[50px]">
