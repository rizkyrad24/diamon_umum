            ...
            <div class="w-[480px] h-[496px] mt-[202.5px] ml-[120px]">
                ...
                <div class="mt-8">
                    ...
                    <form action="" class="mt-2">
                        <input type="text" v-model="username" class="w-[480px] h-[40px] border-[1px] outline-none rounded-lg px-3" placeholder="Masukkan username" name="username" id="username">
                    </form>
                </div>
                <div class="mt-6">
                    ...
                    <form action="" class="mt-2 flex absolute">
                        <input v-model="password" :type="isPasswordVisible ? 'text' : 'password'" class="w-[480px] h-[40px] border-[1px] outline-none rounded-lg px-3" placeholder="Masukkan password" name="password" id="password">
              ...
              <div class="mt-20">
                <button @click="submit" :disabled="isDisableLogin" :class="isDisableLogin? 'w-full h-[48px] bg-[#9C9C9C] text-white font-semibold rounded-lg': 'w-full h-[48px] bg-[#2671D9] text-white font-semibold rounded-lg'">Login</button>
