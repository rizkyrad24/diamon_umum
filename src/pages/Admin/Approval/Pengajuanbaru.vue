              ...
              <li
                :class="{
                  'text-[#2671D9] font-semibold':
                    $route.path === '/Approvalpengajuanbaru',
                  'text-[#7F7F80]': $route.path !== '/Approvalpengajuanbaru',
                }"
                class="py-2"
              >
                <router-link
                      ...
                      >
                        ...
                        <router-link
                          ...
                          :to="{
                            ...
                            query: { origin: 'Approvalpengajuanbaru' }
                          }"
                        >
                          <div
  ...
  methods: {
    ...
    async getDataApi() {
      ...
      if (res.status == 200) {
        ...
        } else if (positionLevel == "vp") {
          const cleanData = res.data.map((item) => {
            if (item.positionLevel == 2) {
              return {
                judul: item.partnershipTitle,
                code: item.id,
                type: item.base == "MOU" ? "MoU" : item.base,
