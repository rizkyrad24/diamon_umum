  ...
  <div class="flex">
    ...
    <div class="flex-grow">
      ...
      <div class="h-auto py-3 px-4 bg-slate-100">
        <!-- Start Content -->
        <div
          class="w-[1217px] h-auto p-1 rounded-lg bg-white min-h-screen mx-auto"
        >
          ...
          <span class="text-base text-[#9C9C9C] pl-4"
            >Approval Surat Pengajuan Mitra</span
          >
          ...
          <div class="px-4 py-4">
            <ul class="flex flex-row">
              <li
                :class="{
                  'text-[#2671D9] font-semibold':
                    $route.path === '/Pengajuanbaru',
                  'text-[#7F7F80]': $route.path !== '/Pengajuanbaru',
                }"
                class="py-2"
              >
                <router-link
                  ...
                  active-class="text-[#2671D9]"
                  exact
                >
                  Pengajuan Baru
                  <div
                    class="absolute w-full h-1 my-2 scale-x-0 group-hover:scale-x-100"
                    :class="{
                      'scale-x-100 bg-[#2671D9]':
                        $route.path === '/Pengajuanbaru',
                    }"
                  ></div>
                </router-link>
              ...
              <li
                :class="{
                  'text-[#2671D9] font-semibold':
                    $route.path === '/Approvaldisetujui',
                  'text-[#7F7F80]': $route.path !== '/Approvaldisetujui',
                }"
                class="py-2"
              >
                <router-link
                  to="/Approvaldisetujui"
                ...
                >
                  Disetujui
                  <div
                    class="absolute w-[80px] ml-6 h-1 my-2"
                    :class="{
                      'bg-[#2671D9] scale-x-100':
                        $route.path === '/Approvaldisetujui',
                    }"
                  ></div>
                </router-link>
              ...
              <li
                :class="{
                  'text-[#2671D9] font-semibold':
                    $route.path === '/Approvalditolak',
                  'text-[#7F7F80]': $route.path !== '/Approvalditolak',
                }"
                class="py-2"
              >
                <router-link
          ...
          <div class="">
            <div class="flex">
              ...
              <div
                class="w-10 h-[41.5px] bg-[#2671D9] rounded-e-lg -translate-x-1"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-[25px] h-[40px] ml-[6px] cursor-pointer"
                  viewBox="0 0 101 101"
                  id="Search"
                >
                  <path
              ...
              <div class="w-[90px] ml-2 filter-container">
                <button
                  ...
                  class="w-[90px] border-[1px] px-1 py-2 flex justify-center rounded-lg"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-[14px] h-[14px] mt-[6px] cursor-pointer"
                ...
                <div
                  v-show="isFilterOpen"
                  class="absolute w-[240px] border-[1px] rounded-lg bg-white z-10 mt-2"
                >
                  <ul class="text-sm w-full">
                    <li class="border-b h-[40px] flex">
                      ...
                      <span class="text-[#7F7F80] ml-2 mt-[10px]"
                        >Pilih Filter</span
                      >
                    </li>
                    <li
                ...
                >
                  <ul class="text-sm w-full">
                    <li
                      @click="updateFilterType('PKS')"
                      class="border-b h-[40px] flex items-center group hover:bg-[#E9F1FB]"
                    >
                      <input
                        type="checkbox"
                        class="w-4 h-4 border-[2px] ml-4 accent-[#2671D9]"
                        :checked="filterType === 'PKS'"
                        readonly
                      />
                      <span
                        class="text-[#333333] ml-2 group-hover:font-semibold group-hover:text-[#2671D9]"
                        :class="{
                          'text-[#2671D9] font-semibold': filterType === 'PKS',
                        }"
                        >PKS</span
                      >
                    </li>
                    <li
                      @click="updateFilterType('NDA')"
                      class="border-b h-[40px] flex items-center group hover:bg-[#E9F1FB]"
                    >
                      <input
                        type="checkbox"
                        class="w-4 h-4 border-[2px] ml-4 accent-[#2671D9]"
                        :checked="filterType === 'NDA'"
                        readonly
                      />
                      <span
                        class="text-[#333333] ml-2 group-hover:font-semibold group-hover:text-[#2671D9]"
                        :class="{
                          'text-[#2671D9] font-semibold': filterType === 'NDA',
                        }"
                        >NDA</span
                      >
                    </li>
                    <li
                      @click="updateFilterType('MoU')"
                      class="border-b h-[40px] flex items-center group hover:bg-[#E9F1FB]"
                    >
                      <input
                        type="checkbox"
                        class="w-4 h-4 border-[2px] ml-4 accent-[#2671D9]"
                        :checked="filterType === 'MoU'"
                        readonly
                      />
                      <span
                        class="text-[#333333] ml-2 group-hover:font-semibold group-hover:text-[#2671D9]"
                        :class="{
                          'text-[#2671D9] font-semibold': filterType === 'MoU',
                        }"
                        >MoU</span
                      >
                    </li>
                ...
                >
                  <ul class="text-sm w-full">
                    ...
                    <li
                      @click="updateFilterStatus('Revisi Mayor')"
                      class="border-b h-[40px] flex items-center group hover:bg-[#E9F1FB]"
                    >
                      <input
                        type="checkbox"
                        class="w-4 h-4 border-[2px] ml-4 accent-[#2671D9]"
                        :checked="filterStatus === 'Revisi Mayor'"
                        readonly
                      />
                      <span
                        class="text-[#333333] ml-2 group-hover:font-semibold group-hover:text-[#2671D9]"
              ...
              <div class="px-[10px] py-[10px] flex">
                ...
                >
                  ...
                  <svg
                    ...
                    width="10"
                    height="10"
                    class="cursor-pointer mr-[7px] mt-[7px]"
                    viewBox="0 0 10 10"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                >
                  ...
                  <svg
                    ...
                    width="10"
                    height="10"
                    class="cursor-pointer ml-1 mr-[7px] mt-[7px]"
                    viewBox="0 0 10 10"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <!-- Start Data -->
            <div
              class="w-[1170px] overflow-auto rounded-lg border-[1px] mt-4 ml-4 h-auto"
            >
                    ...
                    <th class="w-[130px] px-3">
                      <div class="flex justify-between">
                        ...
                        <svg
                          width="16"
                          height="16"
                          class="cursor-pointer ml-4 mt-2"
                          viewBox="0 0 16 16"
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="w-[135px] px-3">
                      <!-- <span
                        class="px-[5px] bg-[#E2FCF3] text-[#0EA976] border-[#8ADFC3] py-1 text-xs font-medium border-1 rounded-[100px]"
                        >{{ row.statusap }}</span
                      > -->
                      <span
                        :class="row.statusClass"
                        class="px-[6px] py-1 text-xs font-medium border-1 rounded-[100px]"
                      >{{ row.statusap }}</span>
                    </td>
                    <td class="w-[54px] px-3">
                      <div
                        @click="toggleView1(index, row.type)"
                      ...
                      <!-- View -->
                      <div
                        v-if="activeViewIndex === index"
                        class="absolute -translate-x-[135px] w-[160px]"
                      >
                        <!-- PKS type -->
                        <router-link
                          v-if="row.type === 'PKS'"
                          :to="{
                            path: `/Detailpengajuanadmin/PKS/${row.code}`,
                            query: { origin: 'Approvaldisetujui' }
                          }"
                        >
                          <div
                          ...
                          >
                            ...
                            <span
                              class="text-[#333333] mt-[10px] hover:text-[#2671D9]"
                              >View</span
                            >
                          </div>
                        </router-link>
                        ...
                        <router-link
                          v-if="row.type === 'MoU'"
                          :to="{
                            path: `/Detailpengajuanadmin/MOU/${row.code}`,
                            query: { origin: 'Approvaldisetujui' }
                          }"
                        >
                          <div
            ...
            <div class="flex">
              ...
              <div class="w-[44px] ml-4 relative data-container">
                <button
                  ...
                  :class="[
                    isDataOpen ? 'rounded-b-lg' : 'rounded-lg',
                    'flex w-[44px] h-8 border-[1px]',
                  ]"
                >
                  ...
                  <svg
                    width="16"
                    height="16"
                    class="mt-2 transition-transform duration-300"
                    :class="{ 'rotate-180': isDataOpen }"
                    viewBox="0 0 16 16"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                >
                  <ul class="text-sm w-full">
                    <li
                      @click="selectDataOption('4')"
                      :class="{
                        'text-black': rowsPerPage === 4,
                        '': rowsPerPage !== 4,
                      }"
                      class="cursor-pointer border-b pl-4 py-1 hover:font-semibold"
                    >
                      4
                    </li>
                    <li
                      @click="selectDataOption('7')"
                      :class="{
                        'text-black': rowsPerPage === 7,
                        '': rowsPerPage !== 7,
                      }"
                      class="cursor-pointer border-b py-1 pl-4 hover:font-semibold"
                    >
                      7
                    </li>
                    <li
                      @click="selectDataOption('8')"
                      :class="{
                        'text-black': rowsPerPage === 8,
                        '': rowsPerPage !== 8,
                      }"
                      class="cursor-pointer pl-4 py-1 hover:font-semibold"
                    >
                      8
                    </li>
                  </ul>
              ...
              <p class="text-sm text-[#333333] mt-1 ml-3">
                dari
                <span class="font-semibold text-sm">{{ dataRows.length }}</span>
                Data
              </p>
            </div>
  ...
  data() {
    return {
      ...
      dataRows: [
        {
          id: 1,
          judul: "Kerja Sama Reseller Produk IBM",
          code: "100122",
          type: "PKS",
          pelaksana: "Pusat",
          status: "Draft",
          statusClass:
            "bg-[#E7F1FD] text-[#4791F2] border-[#91BEF7] border-1 rounded-[100px]",
          statusap: "Perlu Disetujui",
        },
        {
          id: 2,
          judul: "Perjanjian Mitra Bisnis IBM",
          code: "100222",
          type: "PKS",
          pelaksana: "Pusat",
          status: "Draft",
        ...
        {
          id: 3,
          judul: "MoU Kerja Sama Pengembangan J...",
          code: "200923",
          type: "MoU",
          pelaksana: "Pusat",
          status: "Draft",
        ...
        {
          id: 4,
          judul: "NDA FTTH Project Collaboration",
          code: "300122",
          type: "NDA",
          pelaksana: "Pusat",
          status: "Revisi Mayor",
          statusClass:
            "bg-[#FFF6E1] text-[#FFB200] border-[#FFD064] border-1 rounded-[100px]",
          statusap: "Perlu Disetujui",
        },
        {
          id: 5,
          judul: "MoU Rencana Kerja Sama Terkait",
          code: "200223",
          type: "MoU",
          pelaksana: "Pusat",
          status: "Draft",
        ...
        {
          id: 6,
          judul: "Kerja Sama Penyediaan APN Private",
          code: "100523",
          type: "PKS",
          pelaksana: "Pusat",
          status: "Draft",
        ...
        {
          id: 7,
          judul: "NDA Penjajakan Kerja Sama berkaita",
          code: "300223",
          type: "NDA",
          pelaksana: "Pusat",
          status: "Revisi Mayor",
        ...
        {
          id: 8,
          judul: "MoU Rencana Kerja Sama Terkait Pe",
          code: "200423",
          type: "MoU",
          pelaksana: "Pusat",
          status: "Draft",
  ...
  computed: {
    ...
    filteredRows() {
      const filtered = this.dataRows.filter((row) => {
        const typeMatch =
          this.filterType === "" || row.type === this.filterType;
        const statusMatch =
    ...
    paginationPages() {
      const totalPages = this.searchQuery
        ? Math.ceil(
            this.searchedRows.filter(
              (row) => row.statusap === this.filterStatus.value
