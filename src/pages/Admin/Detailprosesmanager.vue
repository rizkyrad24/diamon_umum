  ...
  <div class="flex">
    ...
    <div class="flex-grow">
      ...
      <div class="h-[54px] flex">
        <router-link v-if="origin == 'dashboard'" to="/Dashboardadmin">
          <h1 class="text-[#2671D9] text-sm ml-6 mt-3">Dashboard</h1>
        </router-link>
        <router-link v-else to="/Prosesadmin">
                ...
                <div v-if="base == 'PKS'" class="px-6 mt-6 mb-4 flex justify-between">
                  <div>
                    ...
                    <a :href="linkDownloadKemitraan7" v-if="fileNameKemitraan7"
                      ...
                      <div class="py-2 w-[200px] flex-grow truncate me-4">
                        <span class="text-[#333333] text-sm font-semibold">{{ fileNameKemitraan7 }}</span>
                        <p class="text-[#9E9E9E] text-xs">{{ fileSizeKemitraan7 }}</p>
                      </div>
                    </a>
                    <div v-else class="w-[333px] h-auto">
                      <span class="text-[#9E9E9E] text-sm font-semibold">File belum ada</span>
  ...
  methods: {
    ...
    async getDataApi(base, id) {
      ...
      if (base == "PKS" && position == 'manager') {
        const res = await fetchGet(`manager/pks/proses/${id}`, null, this.$router);
        if (res.status == 200) {
        ...
        const res = await fetchGet(`manager/mounda/proses/${id}`, null, this.$router);
        if (res.status == 200) {
          this.dataBerkas = res.data;
          this.approvalNote = res.data.approvalNote;
          this.responseText = res.data.responseText;
        ...
        const res = await fetchGet(`vp/pks/proses/${id}`, null, this.$router);
        if (res.status == 200) {
          this.dataBerkas = res.data;
          this.approvalNote = res.data.approvalNote;
          this.responseText = res.data.responseText;
        ...
        const res = await fetchGet(`vp/mounda/proses/${id}`, null, this.$router);
        if (res.status == 200) {
          this.dataBerkas = res.data;
          this.approvalNote = res.data.approvalNote;
          this.responseText = res.data.responseText;
